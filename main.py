...
class Teste(nn.Module):
    def __init__(self):
        ...
        self.c1=nn.Linear(5,256) #entradas: 2 binarias para variavel, 2 binarias para variavel filtro, 1 para valor filtro
        self.c2=nn.Linear(256,256)
        self.c3=nn.Linear(256,366)
        self.relu=nn.ReLU()
...
class Teste2(nn.Module):
    def __init__(self):
        super(Teste2, self).__init__()
        self.c1=nn.Linear(3,256) #entradas: 2 binarias para variavel, 1 para dia
        self.c2=nn.Linear(256,256)
...
async def root(attribute:str,agg:str,precision:float,query:str):
    ...
    ref=p[attribute]
    p[attribute]=ret.detach().numpy()[0]
